...
_PHRASES = ["nano", "seed", "ocr_stub", "ocr_stub nano", "ocr_stub nano shengelia", "nano shengelia", "nano shengelia systemoptimizer", "shengelia", "shengelia systemoptimizer", "shengelia systemoptimizer seed"]
def phrase_counter(text=None, phrases=None, **kw):
    terms = [w.lower() for w in re.findall(r'[A-Za-z0-9\-_\u10A0-\u10FF\u2D00-\u2D2F\u1CBF]+', text or '')]
